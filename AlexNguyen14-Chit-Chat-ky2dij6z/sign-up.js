...
var secretValues = ['85858dsd4', '5898sds22', '747483sds8', '74489dsd494', '6sds22', '848sd84', '848383', '985748', '484844', '848484', '4949494', '584949', '838hrj', 'jdjdkd', '8383838', 'jdkdkd', '83ienkd', '748829hjd', 'jfjeuhuheuf', 'hefuhehfi', 'jushidjjd', 'ushduhasid4'];
  ...
  for (var i = 0; i < seperatedText.length; i += 3) {
    ...
    if (isSafeToAddUserData == 0) {
      sessionStorage.setItem('username', usersName.value);
        ...
        var urlToFetch = "https://mainserver.gamedev46.repl.co/api/add/user?username=" + usersName.value + "&pass=" + encodedPass + "&secret=" + secretValues[numberInalphabet];
