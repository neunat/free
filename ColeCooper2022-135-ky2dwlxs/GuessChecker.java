...
public class GuessChecker
{
    ...
    if  (g1 == r1) hit+=1;
        ...
        System.out.println("Miss on one");
      }
    if  (g2 == r2) hit+=1;
        ...
        System.out.println("Miss on two");
      }
    if  (g3 == r3) hit+=1;
        ...
        System.out.println("Miss on three");
      }
    if  (g4 == r4) hit+=1;
        ...
        System.out.println("Miss on four");
      }
  ...
  { 
    ...
    while (!validGuess)
    {
      System.out.println("Guess a 4-digit number from 1000 to 9999 with no duplicate digits: ");
