...
function go() {
alert("Welcome to WordCombiner!\nWhere you can combine 2 words into one!\nPress ok to begin")
var name1 = prompt("Enter the first word:")
var name2 = prompt("Enter the second word:")
if (!(name2 && name1)) return alert("Uh oh, you didn't enter 2 words\nPlease try again.")

alert(name1+" + "+name2 + " = \n\n"+combine(name1, name2)+"\n\nIf you thought this combination was funny/cool, please comment below!")
}
