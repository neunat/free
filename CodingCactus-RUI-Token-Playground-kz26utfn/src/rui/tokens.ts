...
export const themeTokens = {
  /* BACKGROUND */
  backgroundRoot: ['--background-root', '#0F210D', '#EBECED'],
  backgroundDefault: ['--background-default', '#0F310D', '#FCFCFC'],
  backgroundHigher: ['--background-higher', '#1F411D', '#F0F1F2'],
  backgroundHighest: ['--background-highest', '#2F612D', '#E4E5E6'],

  backgroundOverlay: ['--background-overlay', '#0F210DA0', '#F0F1F2A0'],
  ...
  /* OUTLINE */
  outlineDefault: ['--outline-default', '#60786C', '#A0C8AC'],
  outlineDefault25: ['--outline-default-25', '#60786C40', '#A0C8AC40'],
  outlineDimmer: ['--outline-dimmer', '#5F775A', '#B8C2BA'],
  outlineDimmest: ['--outline-dimmest', '#4E7549', '#DEE5D9'],

  /* ACCENTS */

  /* primary */
  accentPrimaryStrongest: ['--accent-primary-strongest', '#B7FABF', '#006D30'],
  accentPrimaryStronger: ['--accent-primary-stronger', '#85FE8F', '#008D40'],
  accentPrimaryDefault: ['--accent-primary-default', '#00cc77', '#00cc77'],
  accentPrimaryDimmer: ['--accent-primary-dimmer', '#008D40', '#85FE8F'],
  accentPrimaryDimmest: ['--accent-primary-dimmest', '#006D30', '#B7FABF'],
