...
for(int i=0; i < days; i++){
  ...
  if(bors == "1" and dollars != 0){
    ...
    std::cout << "\nIf you would like to buy the max amount of shares type 'max', else...\nHow many shares would you like to buy?: ";
    
    std::cin >> buyCost_string;
    
    stringstream buy(sellCost_string);
    buyCost = 0;

    buy << buyCost;
    
    if(buyCost_string == "MAX" || buyCost_string == "max" || buyCost_string == "Max" || buyCost_string == "m a x"){
      std::cout << "---------------------------------------------------------------------\n\n";
    
      //account for bought shares
      shares = shares + (dollars / price);
      dollars = dollars - ((dollars / price) * price);
  ...
  //option 2 sold shares
    ...
    std::cout << "\nIf you would like to sell all of your shares type 'max', else...\nHow many shares would you like to sell?: ";

    std::cin >> sellCost_string;

    stringstream sell(sellCost_string);
    sellCost = 0;

    sell >> sellCost;
    
    if(sellCost_string == "MAX" || sellCost_string == "max" || sellCost_string == "Max"|| sellCost_string == "m a x"){
      std::cout << "---------------------------------------------------------------------\n\n";
