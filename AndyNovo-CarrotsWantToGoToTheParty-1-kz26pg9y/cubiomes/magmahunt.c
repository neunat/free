...
//        printf("Got a ravine start:\n");
        ...
        printf("x: %ld, y: %ld, z: %ld, pitch: %.9f, width: %1.2f, maxlength: %ld\n", magmax, magmay, magmaz, pitch, width, maxLength);
      }
    }
  }
  printf("done magma hunting\n");
  return;
}
