...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send(":x: You Don't Have Enough Permission To Execute This Command - Manage Messages");
    ...
    if (!Msg) return message.channel.send(`:x: Please Give Message\n\nCustom:\n<ServerName> => Server Name\n<MemberName> => Member Name\n<MemberMention> => Member Mention`);
